...
intResW = QtGui.QWidget()
intResLay = QtGui.QHBoxLayout()
intResW.setLayout(intResLay)
intResLabel = QtGui.QLabel('Int line resolution(m)')
intResInput = QtGui.QLineEdit('150')
